...
class PlotFunctionsV1_2(GraphScene):
    CONFIG = {
        "x_min": 0,
        "x_max": 55,
        "x_tick_frequency": 5,
    ...
    def construct(self):
        ...
        graph1 = self.get_graph(self.func1, color=RED)
        graph2 = self.get_graph(self.func2, color=RED)
        graph3 = self.get_graph(self.func3, color=RED)
