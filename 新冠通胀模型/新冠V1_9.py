...
class PlotFunctionsV1_9(GraphScene,Scene):
    ...
    def construct(self):
        ...
        graph_label = self.get_graph_label(graph2, label="\\frac{x^2 - 4x + 5}{2}", x_val=35, direction=UP)
        ...
        ).scale(0.3).set_color('#EEC591')
        text[0].to_corner(5*UR)
        text[1].to_corner(6*UR)
        ...
        self.play(ReplacementTransform(text[2], text[0]))
        self.play(ReplacementTransform(text[3], text[1]))
        self.wait(2)
